class Stocks::EmergencyKitsController < ApplicationController
  ...
  def show
    ...
    @missing_items = required_quantities.filter_map do |category_name, required_quantity|
      ...
      next unless current_quantity < required_quantity
  ...
  def create
    ...
    user = current_user
    EmergencyKitOwner.genders.key(emergency_kit_params[:gender])
    ...
    params[:emergency_kit][:reminders_attributes]&.each_value do |reminder_params|
